...
\end{itemize}
 ...
 \begin{figure}[ht]
\centering
\includegraphics[scale=0.50]{graphics/segmentierung1.png}
\caption{Segmentierung Beispiel}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[scale=0.50]{graphics/segmentierung2.png}
...
\begin{huge}
\textbf{Das ist alles BULLSHIT}
\end{huge}

\subsubsection{Page Fault Latenz}
\begin{itemize}
\item Page Fault Rate $0 \leq p \geq 1.0$
...
\section{Pageersatz}
Was passiert wenn kein freier \textit{Frame} vorhanden ist? $\rightarrow$ Pageersatz. Suche nach der am passendsten \textit{page} im Speicher
